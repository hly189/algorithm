...
\begin{figure}[H]
\centering 
\includegraphics[width = 9cm]{/Users/lythaihoa2311992/R-files/bisection.png}
...
\begin{figure}[H]
\centering 
\includegraphics[width = 9cm]{/Users/lythaihoa2311992/R-files/fixpoint.png}
\caption{$f(x) = x^2 +5x +4$}	
\end{figure}	
\end{ex}
...
\begin{figure}[H]
\centering 
\includegraphics[width = 6.9cm]{/Users/lythaihoa2311992/R-files/newton.png}
\caption{$f(x) = x^2 +5x +4$}	
\end{figure}	
\end{ex}
...
\begin{figure}[H]
\centering 
\includegraphics[width = 6.9cm]{/Users/lythaihoa2311992/R-files/Steffensen.png}
\caption{$f(x) = x^2 +5x +4$}	
\end{figure}	
\end{ex}
